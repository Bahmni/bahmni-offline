...
public class Constants {
    ...
    public static String CREATE_ERRORLOG_TABLE = "CREATE TABLE IF NOT EXISTS error_log (id INTEGER PRIMARY KEY AUTOINCREMENT, failedRequest TEXT, logDateTime DATETIME, responseStatus INTEGER, stackTrace TEXT);";
